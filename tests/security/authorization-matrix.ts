...
export const AUTHORIZATION_MATRIX: MatrixCase[] = [
  ...
  { role: "stock_keeper", resource: "visits", action: "read", site: "own", expect: "DENY",
    because: "0126 restrictive policy" },
  { role: "inventory", resource: "stock_lots", action: "read", site: "own", expect: "ALLOW",
    because: "stock is the inventory employee's lane" },
  { role: "inventory", resource: "stock_lots", action: "read", site: "other", expect: "ALLOW",
